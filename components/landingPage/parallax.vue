<template>
  <div>
    <section class="banner parallax paraImage" style="background-color: #44352d;">
        <div class="container banner-content text-center" data-animation-options="{
            'name': 'blurIn',
            'delay': '.3s'
        }">
...
<style>
.paraImage{
    background: url(../../assets/images/demos/demo1/parallax.jpg);
